...
namespace GitHubManager
{
    ...
    public interface IForm : IWin32Window, IDisposable, ISynchronizeInvoke
    {
        ...
        /// <summary> Occurs when this form is first shown to the user. </summary>
        event EventHandler Shown;

        /// <summary> Closes this form. </summary>
        void Close();

        /// <summary> Hides the form, but does not close it. </summary>
        void Hide();

        /// <summary> Makes this form visible to the user, but not as a modal dialog box. </summary>
        void Show();
